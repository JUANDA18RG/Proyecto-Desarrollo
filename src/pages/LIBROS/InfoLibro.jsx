      ...
      <div className="w-1/2 ml-32">
        ...
        <div className="bg-white p-7 rounded-lg mt-4">
          <p className="text-2xl text-justify">
            ...
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorum qui quas, iste ut aperiam mollitia maiores, distinctio dolores animi laudantium nobis aut! Iste aspernatur perspiciatis necessitatibus? Vero veritatis accusantium excepturi.
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda qui omnis odio laudantium iusto nam nulla excepturi quod, fugit optio neque deserunt sed aperiam? Fugit quidem ducimus quisquam voluptatem libero.
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quae neque mollitia tempora consequuntur, quas odit placeat dolor est aperiam non eligendi laborum aliquam ex tenetur ratione. Laborum repudiandae perferendis inventore!
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste, voluptatem! Facilis alias, assumenda eum sed labore, unde quidem accusamus, fuga suscipit similique quos eaque quo minus libero. Deleniti, sit vitae.
          </p>
        </div>
      </div>
