            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 ">
              {!loading && Array.isArray(resultados) && resultados.length > 0
                ? resultados.map((user) => (
                    <div
                      key={user.id}
                      className="group bg-white rounded-xl m-5 p-2 transition-transform duration-300 ease-in-out transform hover:scale-90 hover:border-4 hover:border-black relative"
                    >
